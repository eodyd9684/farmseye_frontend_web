...
const WeekWeather = () => {
  ...
  //날씨에 따라 들어갈 아이콘
  const weatherIcons = {
    Clear: <i class="bi bi-brightness-high-fill" style={{color: 'orange'}} ></i>,
    Clouds: <i class="bi bi-cloud-fill" style={{color: '#b8ddfb'}}></i>,
    Rain: <i class="bi bi-cloud-drizzle" style={{color: '#b8ddfb'}}></i>,
    Thunderstorm: <i class="bi bi-cloud-lightning-rain" style={{color: '#b8ddfb'}}></i>,
